...
1.  Go to  **Settings.**
2.  In the  **Organization** section, click  **Roles & permissions**.
3.  Select the relevant role.
4.  Click  **Permissions**.
5.  Click  **Account configuration**.
6.  Next to  **Career Frameworks**, select  **All**.
...
Learn to set up a job architecture in our  [dedicated article](https://support.personio.de/hc/en-us/articles/18287573633053). Then create a career framework for each job family.
